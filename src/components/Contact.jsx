...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_mr7pqrj", // Service ID from EmailJS
        "template_zhrcx4h", // Template ID from EmailJS
        form.current,
        {
          publicKey: "PpkznTFVfAuw6dhDz",
        }
      )
      .then(
        (result) => {
    ...
    <section id="contact" className="py-20 bg-light-gray">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-lg">
            Email:{" "}
            <a href="mailto:meghhaayeewwalkar@gmail.com" className="text-primary">
